    ...
    videos: [
      {
        ...
        gradientFrom: '#4A5E52', gradientTo: '#607A6A',
        videoUrl: '/learning/ForEveryAfter_ The Trusted Representative Release_1080p_caption.mp4',
      ...
      },
      {
        ...
        gradientFrom: '#607A6A', gradientTo: '#7A9488',
        videoUrl: '/learning/ForEveryAfter_ Generating Your Obituary_1080p_caption.mp4',
      ...
      },
      {
        ...
        gradientFrom: '#3D5A4A', gradientTo: '#4A6E5A',
        videoUrl: '/learning/ForEveryAfter_ Subscription After Release_1080p_caption.mp4',
